...
moduleForModel('i-i-s-kursovaya-rabota-isp4-оператор', 'Unit | Serializer | i-i-s-kursovaya-rabota-isp4-оператор', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-isp4-оператор',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
