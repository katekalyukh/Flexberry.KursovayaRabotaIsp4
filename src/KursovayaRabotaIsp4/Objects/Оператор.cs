    ...
    public class Оператор : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОператорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОператорE", typeof(IIS.KursovayaRabotaIsp4.Оператор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОператорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОператорL", typeof(IIS.KursovayaRabotaIsp4.Оператор));
                }
            }
        }
    }
